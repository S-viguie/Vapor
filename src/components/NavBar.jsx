        ...
        <header className="flex flex-col items-center">
            ...
            <nav className="flex justify-evenly items-center w-full py-4">
                ...
                <div className="flex flex-col relative">
                    <input type="text" name="search" placeholder="Buscar" className="font-Barlow w-[300px] text-white text-lg border p-1 border-Oro rounded-lg bg-[#461111] outline-none bg-[url('https://firebasestorage.googleapis.com/v0/b/vapor-c6404.appspot.com/o/buscar.png?alt=media&token=5bbd6a95-7bb9-429a-8364-717376ffd066')] bg-[length:20px_20px] bg-no-repeat bg-[center_right_0.5rem] focus:bg-Rojo-Dark" onChange={change} value={value} />
                ...
                <Link to="/fav"> <img src="https://firebasestorage.googleapis.com/v0/b/vapor-c6404.appspot.com/o/favs.png?alt=media&token=86a4b92a-d752-425f-babc-f2f9e4dbe826" alt="favoritos" /> </Link>
